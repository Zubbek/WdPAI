...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/public/css/snack.css" />
  ...
  <body>
    <div class="main-container">
      <header class="header">
        <nav class="navbar">
          <a class="mobile-back" href="../html/main-page.html">
      ...
      <div class="categories">
        <div class="categories-container">
          <div class="categories-info">
            <h1>BEST SNACK RECIPES</h1>
            <p>
              Irresistible Bites for Anytime Cravings! Dive into our "Snack" section, a treasure trove of snackable delights to curb your cravings. From savory to sweet, these snack recipes are perfect for satisfying hunger between meals. Discover easy-to-make treats that bring a burst of flavor to your day, elevating your snacking experience.
